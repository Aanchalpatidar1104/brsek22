    ...
    <div className="row no-gutters">
      <div className="col-12 col-lg-5 d-lg-block d-none">
        <div className="full-screen position-relative d-flex flex-column justify-content-center align-items-center z-index-2">
          ...
          <Link to="/" className="btn-backgrounds btn-backgrounds_transparent btn-backgrounds_left-icon font__family-montserrat font__weight-normal text-uppercase font__size-13 z-index-2 text-center" style={{paddingLeft: 85, paddingRight: 60}} data-brk-library="component__button">
